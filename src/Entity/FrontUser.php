...
class FrontUser implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     * @Assert\NotBlank(message="Veuillez entrer votre prenom sil vous plait")
     */
    private $firstname;

     /**
     * @ORM\Column(type="string", length=180)
     * @Assert\NotBlank(message="veuillez entrer votre nom sil vous plait")
     */
    private $lastname;

    /**
     * @ORM\OneToMany(targetEntity=Reservation::class, mappedBy="frontUser")
     */
    private $reservation;
    ...
    public function removeReservation(Reservation $reservation): self
    {
        if ($this->reservation->removeElement($reservation)) {
            ...
            if ($reservation->getFrontUser() === $this) {
                $reservation->setFrontUser(null);
            }
        }
